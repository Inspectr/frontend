...
ARG REACT_APP_API_URI=http://localhost:3011
ENV REACT_APP_API_URI=${REACT_APP_URI}

ARG REACT_APP_WSS_URI=http://localhost:3011
ENV REACT_APP_WSS_URI=${REACT_APP_WSS_URI}
